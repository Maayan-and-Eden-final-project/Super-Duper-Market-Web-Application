...
function refreshAreasList(areas) {
    ...
    $.each(areas || [], function(index, areaContainer) {
        ...
        "    </div>\n" +
        "    <div class=\"card-body\">\n" +
        "       <h1 class=\"card-title pricing-card-title\">Area Owner: <small class=\"text-muted\">areaContainer.areaOwner </small></h1>\n" +
        "       <ul class=\"list-unstyled mt-3 mb-4\">\n" +
        "           <li>Number Of Stores: areaContainer.storesInArea </li>\n" +
        "           <li>Number Of Items: areaContainer.itemsInArea</li>\n" +
        "           <li>Number Of Orders: areaContainer.ordersInArea</li>\n" +
        "           <li>Average Orders Costs: areaContainer.avgOrdersCostsInArea</li>\n" +
        "       </ul>\n" +
